...
KEEP_FULL_TOURNEY_DATA_FOR_MONTHS: int = int(os.getenv("KEEP_FULL_TOURNEY_DATA_FOR_MONTHS", 3))
KEEP_FULL_NON_TOURNEY_DATA_FOR_MONTHS: int = int(os.getenv("KEEP_FULL_NON_TOURNEY_DATA_FOR_MONTHS", 1))
