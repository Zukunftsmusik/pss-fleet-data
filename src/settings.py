...
KEEP_FULL_TOURNEY_DATA_FOR_MONTHS: int = int(os.getenv("KEEP_FULL_TOURNEY_DATA_FOR_MONTHS", 3))  # Unused
KEEP_FULL_NON_TOURNEY_DATA_FOR_MONTHS: int = int(os.getenv("KEEP_FULL_NON_TOURNEY_DATA_FOR_MONTHS", 1))  # Unused
DELETE_FULL_DATA_AFTER_MONTHS: int = int(os.getenv("DELETE_FULL_DATA_AFTER_MONTHS", 3))
